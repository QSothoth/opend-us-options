...
python3 -m custody evaluate --strategy zero_dte_timing_v6.1 \
  --dataset data/custody-0dte-v6 --out reports/zero_dte_timing_v6.5/custody-0dte-v6
```
...
- 当前唯一训练集 `custody-0dte-v6`（含原 V5 + 已吸收的 2026-09-16）；唯一正式验证集 `custody-eval-2026-09-18`；`custody-stress-v1` 仅诊断。历史报告路径仍可能写 V5 / 09-16-v2，那是当时研究记录。
