...
| W6 | **日线背景 K5（逆近 5 日 + 未破昨日高低点）：验证通过，盯盘加 `D+`/`D-`**（支持到收盘 +17.6bp vs 不支持 −14.7bp，差值 t=3.1） |
| W4 | 分钟资金流：已预登记；**未逐日采集**（由用户决定）。2026-09-24 单日测试见 [reports/FLOW_2026-09-24_CN.md](reports/FLOW_2026-09-24_CN.md) |
